  ...
  return (<>
    ...
    <div className="wrapper">
      ...
      <div className="tableContainer" >
        <div className="tableTop" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <select 
            ...
            style={{ padding: '8px 16px', borderRadius: '6px', border: '1px solid #cbd5e1', fontSize: '1rem', outline: 'none', background: 'white', cursor: 'pointer', color: '#334155', fontWeight: 500 }}
          >
            <option value="">All Astrologers</option>
            <option value="APPROVED">Active (Approved)</option>
            <option value="WFA,SUBMITTED">Pending (WFA/Submitted)</option>
